...
const eggWagonsMenu = menuData[0].menu.eggwagons;

console.log(eggWagonsMenu);

const Eggwagons = () => {
  const [eggWagons, setEggWagonsMenu] = useState([]);

  useEffect(() => {
    setEggWagonsMenu(eggWagons);
  }, []);

  const renderItems = eggWagonsMenu.map((item, i) => {
    return (
